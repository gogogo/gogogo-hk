...
def _get_key_string(model,key=None,key_name=None , key_string = None):
	if key:
		key_string = str(key)
	elif key_string:
		pass
...
def getCacheObjectKey(model = None , key=None,key_name=None , key_string = None):
	return "gogogo__key__%s" % str(_get_key_string(model=model , key=key,key_name=key_name,key_string= key_string) ) 

def getCacheEntityKey(model = None , key=None,key_name=None , key_string = None):
	return "gogogo__entity__%s" % str(_get_key_string(model=model , key=key,key_name=key_name,key_string= key_string) ) 
...
def getCachedObjectOr404(model,key=None,key_name=None):
	...
	cache_key = getCacheObjectKey(model = model , key=key , key_name = key_name)
...
def getCachedEntityOr404(model,key=None,key_name=None):
	...
	cache_key = getCacheEntityKey(model = model ,key=key , key_name = key_name)
